...
Write-Host "  1. Create a release at https://github.com/Majestic95/LunaMultiplayer/releases/new"
Write-Host "  2. Tag with the fork version (e.g. v0.30.0-Majestic95-private-1)"
Write-Host "  3. Drag-drop the zips from $ReleasesRoot into the release UI"
Write-Host "  4. In the release notes: tell testers NOT to click 'check for updates'"
