...
// Duplicated from Server/Settings/Definition/WebsiteSettingsDefinition.cs.
[Serializable]
public class WebsiteSettingsDefinition
{
    ...
    [XmlComment(Value = "The address that the web server listens on. Falls back to ConnectionSettings.ListenAddress if unset, which defaults to [::]")]
